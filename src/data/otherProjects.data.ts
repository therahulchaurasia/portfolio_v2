export const otherProjectsData = [
  ...
  {
    name: "My Music Pie Chart",
    href: "https://mymusicpiechart.com/",
    description:
      "My Music Pie Chart is a fun and interactive project that I built to for a client by connecting to the Spotify API. It generates colorful pie charts that shows the distribution of top artists, albums, and genres. Users can easily share their music tastes with friends and family, making it a delightful way to explore and celebrate their unique musical preferences.",
    tools: ["JavaScript", "Next JS", "Chakra UI", "SEO"],
  },
  // {
